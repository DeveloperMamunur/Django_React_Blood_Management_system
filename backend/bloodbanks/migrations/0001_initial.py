    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='blood_banks', to='locations.location')),
                ('managed_by', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='managed_blood_banks', to=settings.AUTH_USER_MODEL)),
            ],
            options={
