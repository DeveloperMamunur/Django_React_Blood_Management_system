...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Campaign Banner */}
      <div className="bg-linear-to-r from-red-600 to-red-500 text-white py-3 px-4 sm:px-6 lg:px-8 my-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {campaigns?.map((campaign) => (
              ...
              >
                ...
                <div className="relative h-48 bg-linear-to-br from-red-500 to-pink-500 overflow-hidden">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className={"bg-linear-to-r from-red-500 to-pink-500 rounded-3xl p-12 text-center text-white"}>
